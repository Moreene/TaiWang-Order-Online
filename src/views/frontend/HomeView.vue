<template>
    ...
    <div class="container">
        <div class="py-72">
            ...
            <div class="text-center">
                <RouterLink to="/categories/recommendation"
                    class="btn btn-secondary link-light text-notoSans px-52 py-8">
                    查看更多</RouterLink>
            </div>
        </div>
    </div>
                ...
                <template v-for="(item, idx) in categories" :key="item.name">
                    <div class="col-6 col-md-3">
                        <div class="d-flex flex-column align-items-center">
                            <RouterLink :to="`/categories/${item.path}`" ref="tastyLinks"
                                @mouseover="handleMouseOver(idx)" @mouseout="handleMouseOut">
